...
mymap :: (a -> b) [a] -> [b]
mymap f list = foldr (\x acc -> [f x : acc]) [] list
...
alternatingSum [] = 0
alternatingSum [x,y,z:xs] = x-y+z - alternatingSum xs
